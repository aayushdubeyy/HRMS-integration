...
type MandatoryFieldsSelectorProps = {
  selected_fields: string[];
  onChange: (selected_fields: string[]) => void;
};

export function MandatoryFieldsSelector({
  selected_fields,
  onChange,
}: MandatoryFieldsSelectorProps) {
  ...
  return (
    <CollapsibleSection
      ...
      description="Select amber keys that must be present for each employee."
    >
